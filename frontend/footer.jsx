...
const Footer = () => {
    return (
        <footer id="footer" className="bg-neutral-900 relative pt-2 pb-10 overflow-hidden rotating-border">
  <div className="">
    <div className="pt-8 border-t border-neutral-800">
    <div className="container mx-auto px-6">
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
      <div className="space-y-6">
        <h3 className="text-2xl font-bold text-[#FFB302]">EcoTrackAI</h3>
        <p className="text-neutral-400">
          Protecting pollution through technology and community engagement.
        </p>
      ...
      <div>
        ...
        <p className="text-neutral-400 mb-4">
          Stay updated with latest pollution activities and protection
          guidelines.
        </p>
        <form className="space-y-4 text-neutral-400">
          <div>
            <input
              type="email"
    ...
    <div className="border-t border-neutral-800 pt-8">
      <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <div className="text-neutral-400 text-sm">
          © 2024 EcoTrackAI. All rights reserved.
        </div>
